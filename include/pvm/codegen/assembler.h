...
namespace ngu::pvm {
     ...
     * Standard (@c dst + @c src):  @c MOV, @c ADD, @c SUB, @c XOR, @c AND, @c OR, @c SHL, @c SHR,
     * @c ROL, @c ROR, @c CMP. @n Unary (@c dst):              @c NOT. @n Branches (@c offset): @c
     * JMP, @c JMPA, @c JMPI, @c JNE, @c JE, @c JNEI, @c JEI. @n Meta (@c label_id):          @c
     * LABEL, @c JMPL, @c JEL, @c JNEL - resolved into real instructions on the final pass. @n No
     * operands:                 @c NOP, @c HALT.
     *
     * @par Operand
    ...
    public:
        ...
        consteval detail::insn_data NOT(const arch::reg dst) const {
            return {
                insn_encoder::make_header(
                    arch_.ops.NOT, arch::insn_size::WORD, arch::insn_mode::REGISTER, detail::phys_reg(arch_, dst), 0
                ),
                0,
                arch::insn_size::WORD
            };
        ...
        consteval detail::insn_data MOV(const arch::reg dst, const operand src) const {
            if (src.is_imm) {
                ...
                return {
                    insn_encoder::make_header(
                        arch_.ops.MOV, sz, arch::insn_mode::IMMEDIATE, detail::phys_reg(arch_, dst), 0
                    ),
                    src.value,
                    sz
                };
            ...
            return {
                insn_encoder::make_header(
                    arch_.ops.MOV,
                    arch::insn_size::DWORD,
                    arch::insn_mode::REGISTER,
                    detail::phys_reg(arch_, dst),
                    detail::phys_reg(arch_, static_cast<arch::reg>(src.value))
                ),
                0,
                arch::insn_size::DWORD
            };
        ...
        consteval detail::insn_data XOR(const arch::reg dst, const operand src) const {
            if (src.is_imm) {
                ...
                return {
                    insn_encoder::make_header(
                        arch_.ops.XOR, sz, arch::insn_mode::IMMEDIATE, detail::phys_reg(arch_, dst), 0
                    ),
                    src.value,
                    sz
                };
        ...
        consteval detail::insn_data ADD(const arch::reg dst, const operand src) const {
            if (src.is_imm) {
                ...
                return {
                    insn_encoder::make_header(
                        arch_.ops.ADD, sz, arch::insn_mode::IMMEDIATE, detail::phys_reg(arch_, dst), 0
                    ),
                    src.value,
                    sz
                };
        ...
        consteval detail::insn_data SUB(const arch::reg dst, const operand src) const {
            if (src.is_imm) {
                ...
                return {
                    insn_encoder::make_header(
                        arch_.ops.SUB, sz, arch::insn_mode::IMMEDIATE, detail::phys_reg(arch_, dst), 0
                    ),
                    src.value,
                    sz
                };
        ...
        consteval detail::insn_data SHL(const arch::reg dst, const operand src) const {
            if (src.is_imm) {
                ...
                return {
                    insn_encoder::make_header(
                        arch_.ops.SHL, sz, arch::insn_mode::IMMEDIATE, detail::phys_reg(arch_, dst), 0
                    ),
                    src.value,
                    sz
                };
        ...
        consteval detail::insn_data SHR(const arch::reg dst, const operand src) const {
            if (src.is_imm) {
                ...
                return {
                    insn_encoder::make_header(
                        arch_.ops.SHR, sz, arch::insn_mode::IMMEDIATE, detail::phys_reg(arch_, dst), 0
                    ),
                    src.value,
                    sz
                };
        ...
        consteval detail::insn_data AND(const arch::reg dst, const operand src) const {
            if (src.is_imm) {
                ...
                return {
                    insn_encoder::make_header(
                        arch_.ops.AND, sz, arch::insn_mode::IMMEDIATE, detail::phys_reg(arch_, dst), 0
                    ),
                    src.value,
                    sz
                };
        ...
        consteval detail::insn_data OR(const arch::reg dst, const operand src) const {
            if (src.is_imm) {
                ...
                return {
                    insn_encoder::make_header(
                        arch_.ops.OR, sz, arch::insn_mode::IMMEDIATE, detail::phys_reg(arch_, dst), 0
                    ),
                    src.value,
                    sz
                };
        ...
        consteval detail::insn_data ROL(const arch::reg dst, const operand src) const {
            if (src.is_imm) {
                ...
                return {
                    insn_encoder::make_header(
                        arch_.ops.ROL, sz, arch::insn_mode::IMMEDIATE, detail::phys_reg(arch_, dst), 0
                    ),
                    src.value,
                    sz
                };
        ...
        consteval detail::insn_data ROR(const arch::reg dst, const operand src) const {
            if (src.is_imm) {
                ...
                return {
                    insn_encoder::make_header(
                        arch_.ops.ROR, sz, arch::insn_mode::IMMEDIATE, detail::phys_reg(arch_, dst), 0
                    ),
                    src.value,
                    sz
                };
        ...
        consteval detail::insn_data CMP(const arch::reg dst, const operand src) const {
            if (src.is_imm) {
                ...
                return {
                    insn_encoder::make_header(
                        arch_.ops.CMP, sz, arch::insn_mode::IMMEDIATE, detail::phys_reg(arch_, dst), 0
                    ),
                    src.value,
                    sz
                };
        ...
        consteval detail::insn_data JMP(const operand offset) const {
            if (offset.is_imm) {
                ...
                return {
                    insn_encoder::make_header(arch_.ops.JMP, sz, arch::insn_mode::IMMEDIATE, 0, 0), offset.value, sz
                };
            }
            return {
                insn_encoder::make_header(
                    ...
                    arch::insn_mode::REGISTER,
                    0,
                    static_cast<std::uint8_t>(offset.value)
                ),
                0,
                arch::insn_size::DWORD
            };
        ...
        consteval detail::insn_data JMPA(const operand offset) const {
            if (offset.is_imm) {
                auto const sz = detail::calc_insn_size(offset.value, offset.is_signed);
                return {
                    insn_encoder::make_header(arch_.ops.JMPA, sz, arch::insn_mode::IMMEDIATE, 0, 0), offset.value, sz
                };
            }
            return {
                insn_encoder::make_header(
        ...
        consteval detail::insn_data JMPI(const operand offset) const {
            if (offset.is_imm) {
                auto const sz = detail::calc_insn_size(offset.value, offset.is_signed);
                return {
                    insn_encoder::make_header(arch_.ops.JMPI, sz, arch::insn_mode::IMMEDIATE, 0, 0), offset.value, sz
                };
            }
            return {
                insn_encoder::make_header(
        ...
        consteval detail::insn_data JNE(const operand offset) const {
            if (offset.is_imm) {
                auto const sz = detail::calc_insn_size(offset.value, offset.is_signed);
                return {
                    insn_encoder::make_header(arch_.ops.JNE, sz, arch::insn_mode::IMMEDIATE, 0, 0), offset.value, sz
                };
            }
            return {
                insn_encoder::make_header(
        ...
        consteval detail::insn_data JE(const operand offset) const {
            if (offset.is_imm) {
                auto const sz = detail::calc_insn_size(offset.value, offset.is_signed);
                return {
                    insn_encoder::make_header(arch_.ops.JE, sz, arch::insn_mode::IMMEDIATE, 0, 0), offset.value, sz
                };
            }
            return {
                insn_encoder::make_header(
        ...
        consteval detail::insn_data JNEI(const operand offset) const {
            if (offset.is_imm) {
                auto const sz = detail::calc_insn_size(offset.value, offset.is_signed);
                return {
                    insn_encoder::make_header(arch_.ops.JNEI, sz, arch::insn_mode::IMMEDIATE, 0, 0), offset.value, sz
                };
            }
            return {
                insn_encoder::make_header(
        ...
        consteval detail::insn_data JEI(const operand offset) const {
            if (offset.is_imm) {
                auto const sz = detail::calc_insn_size(offset.value, offset.is_signed);
                return {
                    insn_encoder::make_header(arch_.ops.JEI, sz, arch::insn_mode::IMMEDIATE, 0, 0), offset.value, sz
                };
            }
            return {
                insn_encoder::make_header(
        ...
        consteval detail::insn_data LABEL(const std::uint32_t label_id) const {
            return {
                insn_encoder::make_header(
                    arch::meta_op::OP_LABEL, arch::insn_size::DWORD_D, arch::insn_mode::IMMEDIATE, 0, 0
                ),
                label_id,
                arch::insn_size::DWORD_D
            };
        }
        ...
        consteval detail::insn_data JMPL(const std::uint32_t label_id) const {
            return {
                insn_encoder::make_header(
                    arch::meta_op::OP_JMPL, arch::insn_size::DWORD_D, arch::insn_mode::IMMEDIATE, 0, 0
                ),
                label_id,
                arch::insn_size::DWORD_D
            };
        ...
        consteval detail::insn_data JEL(const std::uint32_t label_id) const {
            return {
                insn_encoder::make_header(
                    arch::meta_op::OP_JEL, arch::insn_size::DWORD_D, arch::insn_mode::IMMEDIATE, 0, 0
                ),
                label_id,
                arch::insn_size::DWORD_D
            };
        ...
        consteval detail::insn_data JNEL(const std::uint32_t label_id) const {
            return {
                insn_encoder::make_header(
                    arch::meta_op::OP_JNEL, arch::insn_size::DWORD_D, arch::insn_mode::IMMEDIATE, 0, 0
                ),
                label_id,
                arch::insn_size::DWORD_D
            };
        ...
        consteval detail::insn_data NOP() const {
            return {
                insn_encoder::make_header(arch_.ops.NOP, arch::insn_size::BYTE, arch::insn_mode::REGISTER, 0, 0),
                0,
                arch::insn_size::BYTE
            };
        }
        ...
        consteval detail::insn_data HALT() const {
            return {
                insn_encoder::make_header(arch_.ops.HALT, arch::insn_size::BYTE, arch::insn_mode::REGISTER, 0, 0),
                0,
                arch::insn_size::BYTE
            };
        }
