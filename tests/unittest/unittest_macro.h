...
TEST_F(VirtualMachineTest, MacroZero) {
    constexpr auto code =
        PVM_ASSEMBLE(arch, cr.MOV(arch::reg::REG_R1, operand(0xDEADBEEFu)), cr.ZERO(arch::reg::REG_R1), cr.HALT());
...
TEST_F(VirtualMachineTest, MacroNeg) {
    constexpr auto code =
        PVM_ASSEMBLE(arch, cr.MOV(arch::reg::REG_R1, operand(5u)), cr.NEG(arch::reg::REG_R1), cr.HALT());
...
TEST_F(VirtualMachineTest, MacroNegZero) {
    constexpr auto code =
        PVM_ASSEMBLE(arch, cr.MOV(arch::reg::REG_R1, operand(0u)), cr.NEG(arch::reg::REG_R1), cr.HALT());
...
TEST_F(VirtualMachineTest, MacroAbsPositive) {
    constexpr auto code = PVM_ASSEMBLE(
        arch, cr.MOV(arch::reg::REG_R1, operand(42u)), cr.ABS(arch::reg::REG_R1, arch::reg::REG_R2, 1), cr.HALT()
    );
...
TEST_F(VirtualMachineTest, MacroAbsZero) {
    constexpr auto code = PVM_ASSEMBLE(
        arch, cr.MOV(arch::reg::REG_R1, operand(0u)), cr.ABS(arch::reg::REG_R1, arch::reg::REG_R2, 1), cr.HALT()
    );
